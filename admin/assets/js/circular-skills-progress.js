// start skills code
function progressBar(namePogress, namePogressEatch, backgroundColor) {
    $(document).ready(function() {
        $(namePogress).find('b').each(function(i) {
        ...
        return $(namePogressEatch).each(function(i) {
 ...
 progressBar('.skill-box', '.skill-box .skills-circle li','rgba(58, 114, 0, 1)');
